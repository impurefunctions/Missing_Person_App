...
//                            : FileImage(_image)
  ...
  Future writeDataToDataBase(FirebaseUser currentUser) async {
    AbsaCompetitionApp.firestore
        ...
        .setData({
      AbsaCompetitionApp.userUID: currentUser.uid,
      AbsaCompetitionApp.userEmail: currentUser.email,
    ...
    await AbsaCompetitionApp.sharedPreferences
        .setString(AbsaCompetitionApp.userUID, currentUser.uid);
    await AbsaCompetitionApp.sharedPreferences.setStringList(AbsaCompetitionApp.userFriendList, ['garbageValue']);
    await AbsaCompetitionApp.sharedPreferences
        .setString(AbsaCompetitionApp.userEmail, currentUser.email);
    await AbsaCompetitionApp.sharedPreferences
